...
function EventCard({ eventId }: Readonly<{ eventId: Id<"events"> }>) {
  const { user } = useUser();
      ...
      return (
        <div className="mt-4 flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-100">
          ...
          <Button
            ...
            size={"sm"}
            className="bg-green-600 hover:bg-green-700 rounded-full px-3 py-1.5 transition-colors duration-200 shadow-sm"
          >
            View your ticket
          </Button>
        </div>
  ...
  console.log(availability.activeOffers);
  ...
  return (
    ...
    >
      ...
      <div className={`p-6 ${imageUrl ? "relative" : ""}`}>
        ...
        <p className="mt-4 text-gray-600 text-sm line-clamp-2 text-warp">
          {event.description}
        </p>
