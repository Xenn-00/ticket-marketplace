...
function SellerEventCard({
  ...
  return (
    <>
      {isDesktop && (
        <div
          className={`bg-white rounded-xl shadow-sm border ${event.is_cancelled ? "border-red-200" : "border-gray-200"} overflow-hidden`}
        >
          <div className="p-6">
            <div className="flex items-start gap-6">
              {/* Event Image */}
              {imageUrl && (
                <div className="relative translate-y-2 w-40 h-40 rounded-xl overflow-hidden shrink-0">
                  <Image
                    src={imageUrl}
                    alt={event.name}
                    fill
                    ...
                    {!isPastEvent && !event.is_cancelled && (
                      <>
                        <Link
                          ...
                          className="shrink-0 flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-xl hover:bg-gray-200 transition-colors"
                        >
        ...
        >
          <div className="p-4">
            <div className="flex flex-col items-start gap-6">
              {imageUrl && (
                <div className="relative translate-y-2 w-full h-40 rounded-xl overflow-hidden shrink-0">
                  <Image
                    src={imageUrl}
                    alt={event.name}
                    fill
